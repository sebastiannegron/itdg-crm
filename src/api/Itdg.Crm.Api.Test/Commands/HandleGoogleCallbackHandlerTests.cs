...
public class HandleGoogleCallbackHandlerTests
{
    ...
    private readonly HandleGoogleCallbackHandler _handler;

    public HandleGoogleCallbackHandlerTests()
    {
        ...
        _logger = Substitute.For<ILogger<HandleGoogleCallbackHandler>>();
        _handler = new HandleGoogleCallbackHandler(
    ...
    public async Task HandleAsync_CreatesNewToken_WhenNoExistingToken()
    {
        ...
        // Act
        await _handler.HandleAsync(new HandleGoogleCallback(code), "en", Guid.NewGuid(), CancellationToken.None);
        ...
        capturedToken.Provider.Should().Be("Google");
    ...
    public async Task HandleAsync_ThrowsException_WhenUserNotFound()
    {
        ...
        await FluentActions.Invoking(() =>
            _handler.HandleAsync(new HandleGoogleCallback("code"), "en", Guid.NewGuid(), CancellationToken.None))
