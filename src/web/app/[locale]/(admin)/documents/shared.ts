...
export type { DocumentDto, DocumentDetailDto, DocumentVersionDto, PaginatedDocuments, ClientDto, DocumentCategoryDto, DocumentSearchResultDto, PaginatedSearchResults };
